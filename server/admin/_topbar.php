...
$iCsv    = '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M12 18v-6"/><path d="M9 15l3 3 3-3"/></svg>';
...
<div class="topbar">
  ...
  <div class="topbar-ctx">
    ...
    <?php if ($__exportEventId): ?>
      <a href="/admin/export.php?event_id=<?= (int)$__exportEventId ?>"
         class="tb-btn tb-icon-btn" aria-label="Exportar CSV" title="Exportar CSV">
        <?= $iCsv ?>
      </a>
    <?php endif; ?>

    <?php if ($__secondaryCsvHref): ?>
      <a href="<?= htmlspecialchars($__secondaryCsvHref, ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8') ?>"
         class="tb-btn tb-icon-btn" aria-label="Exportar reservas CSV" title="Exportar reservas CSV">
        <?= $iCsv ?>
      </a>
    <?php endif; ?>
...
<nav class="bottom-tabs" aria-label="Navegação principal">
  ...
  <a href="/admin/link-bookings.php"
     ...
     <?= $isLinks ? 'aria-current="page"' : '' ?>>
    <?= $iLink ?>
    <span class="btab-label">Reservas</span>
  </a>
